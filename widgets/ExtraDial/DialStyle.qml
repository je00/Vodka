...
Style {
    ...
    property alias __handleHelper: handleHelper
    ...
    */
    property Component background: Item {
        ...
        Canvas {
            ...
            Connections {
                target: dialStyle
                onUpdateStyle: backgroundCanvas.requestPaint();
            }
    ...
    */
    property Component handle: Canvas {
        ...
        Connections {
            target: dialStyle
            onUpdateStyle: handleCanvas.requestPaint();
        }
    ...
    */
    property Component tickmark: Rectangle {
        ...
        radius: height / 2
        color: styleData.index === 0 ? "transparent" : __handleHelper.handleRingColorTop
        antialiasing: true
        border.width: styleData.index === 0 ? Math.max(1, outerRadius * 0.01) : 0
        border.color: __handleHelper.handleRingColorTop
    }
    ...
    */
    ...
    CircularButtonStyleHelper {
        ...
        smallestAxis: Math.min(control.height, control.width) - __tickmarkRadius * 4
    }
